...
No program rows at all yet — only the base `universities` row (name, city, acceptance rate, website, international tuition, currency):

Bond University, Murdoch University, University of Canberra.
...
**2026-08-25: 16 universities moved from this list into "Done"** (CQUniversity Australia, University of the Sunshine Coast, University of Western Australia, Australian Catholic University, Macquarie University, University of New England, Charles Sturt University, Southern Cross University, University of Notre Dame Australia, Avondale University, Victoria University, Federation University Australia, Griffith University, University of Southern Queensland, Torrens University Australia, University of Tasmania) — see the new sub-table above the ECU/JCU/Newcastle paragraph. Griffith and Macquarie in particular had been skipped twice before due to Cloudflare-blocked `.edu.au` domains; both were completed this round using aggregator sources (IDP) directly as `source_url`, now that approximate/aggregator-sourced figures are acceptable — no need to keep retrying the blocked domains for these two.

**2026-08-25, TAFE/vocational triage pass: 13 more moved from this list into "Done"** (Australian Institute of Business, Australian Institute of Music, Box Hill Institute, Holmes Institute, International College of Management Sydney, Kaplan Business School, Melbourne Institute of Technology, Melbourne Polytechnic, National Institute of Dramatic Art (NIDA), TAFE NSW, TAFE Queensland, University of Divinity, William Angliss Institute) — see the new "TAFE/vocational triage pass" sub-table above. Each got a program row for its actual flagship offering (mostly MBAs and Masters of IT for the private higher-ed providers, plus two genuine bachelor's degrees for the dual-sector TAFEs — TAFE NSW's own Bachelor of IT and TAFE Queensland's own Bachelor of Nursing, not partner-university pathway degrees). **3 of the 16 were deliberately left with no program row** (Greenwich College — ELICOS/pathway-only, no degree of its own; South Metropolitan TAFE — VET-only; Victoria University Polytechnic — VU's TAFE division, distinct from the already-covered "Victoria University" entity) — see the explicit skip note above.

Only 3 institutions remain with no program row at all, and none of them are vocational/specialist edge cases — they're ordinary universities that just haven't been picked up yet.

**Suggested next batch**: Bond University, Murdoch University, and University of Canberra are ordinary universities likely to have a clean Master of CS/IT fit — the last 3 of 58 to reach "has a program row."
