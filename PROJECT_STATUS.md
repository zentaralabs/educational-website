...
- **Progress as of 2026-08-29: 187 written** (Bond ~56, Adelaide 63, Murdoch 31, Canberra 37); Adelaide degree-level stubs now essentially cleared (remaining Adelaide stubs are honours-only, combined-degree, or Master of Engineering / Bachelor of Music / Bachelor of Teaching rows with no cleanly matchable single course page), **12 discontinued programs archived** (Bond: Exercise and Sports Science, Business Data Analytics + Professional twin, Social Science, Master of International Relations, Master of Project Innovation; more expected). **248 empty-published stubs remain.**
