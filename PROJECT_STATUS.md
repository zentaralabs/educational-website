...
- **Long-tail pass IN PROGRESS (2026-08-29):** user wants the ~212 remaining stubs described too, but "in the best interest of AdSense approval, not filling AI content blindly" — so: family-templated batches where the templated card carries real per-row substance (specific subjects, accreditation, honest limitations), decline to a minimal card where nothing genuine can be said, archive junk rows. Un-hide (drop noindex + add programs to sitemap) happens as ONE wave AFTER all descriptions are done, gated on description presence/quality.
  - **Batch 10 done:** 7 real Canberra coursework master's that were hiding in the "needs eyes" bucket (Building & Construction Information Management, Business Informatics, Counselling, Master of Education, Master of Education Studies, Educational Leadership and Management, TESOL & FLT). **205 stubs remain.**
  ...
  - Still to do: ~11 Murdoch master's with generic `study/courses` URLs (need real course pages), 3 Adelaide name-mismatch degrees (Music, Teaching, Engineering), 3 Canberra generic bachelors, research-degree templates (~15), honours templates (~21), pathway/enabling real ones + archive junk, then the 116 grad cert/diploma family cards.
