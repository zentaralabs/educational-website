...
- **Progress as of 2026-08-29: 204 written** (Bond ~62, Adelaide 63, Murdoch 34, Canberra 45); Canberra + Murdoch bachelor sweeps picked up cleanly-matchable degrees missed earlier (Canberra: Arts, Commerce (Business Economics), Digital Design (Digital Media), Early Childhood Education, Engineering Technology, Medical Imaging, Occupational Therapy, Science; Murdoch: Arts, Creative Media, Applied Social Care). Adelaide degree-level stubs now essentially cleared (remaining Adelaide stubs are honours-only, combined-degree, or Master of Engineering / Bachelor of Music / Bachelor of Teaching rows with no cleanly matchable single course page), **17 discontinued programs archived** (Bond: Exercise and Sports Science, Business Data Analytics + Professional twin, Social Science, Master of International Relations, Master of Project Innovation, Master of BIM and Integrated Project Delivery, Master of Laws in Family Dispute Resolution, Bachelor of Exercise and Sports Performance, Bachelor of Health Transformation; Murdoch: Bachelor of Science B1317). **226 empty-published stubs remain.**
