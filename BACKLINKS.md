...
| Instagram | ✅ 2026-09-01 — account **@where_to_apply** (created by Roman). Logo profile pic + bio set. First post live: "65 points" content, points-calculator screenshot as image (`scripts/ph-screenshots/4`). Caption was reworked to name the site, give `wheretoapply.xyz/blog`, explain what the account is, and say "link in bio". IG-APP-ONLY, still to do: (1) add the bio website link `https://www.wheretoapply.xyz` (IG web blocks link editing — this is why the caption also spells out the URL), (2) optionally set the profile Name to "Where To Apply" (currently shows as "Wheretoapply.xyz"). | 2026-09-01 | instagram.com/where_to_apply |
