...
| Connectively signup | ⚠️ 2026-09-01 — PARKED. Account + email verified, but the expert profile (required before you can submit answers) has a MANDATORY LinkedIn field that only accepts a personal linkedin.com/in/ URL and rejects blank + the company page. Roman decided NOT to create a personal LinkedIn (2026-09-01), so Connectively stays a dormant account — can't pitch there. Featured still surfaces Connectively requests but they're not actionable. Revisit only if Roman ever makes a personal LinkedIn. | 2026-09-01 | none (parked) |
