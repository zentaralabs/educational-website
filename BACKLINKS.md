...
| Connectively signup | ⏳ 2026-09-01 — account created + email confirmed (admin@wheretoapply.xyz, Roman Lama). Browser session was lost before profile setup; Roman needs to log back in at connectively.us/login (email pre-filled) then Claude fills the expert profile. Connectively is NOT dead (plan said Dec 2024 shutdown — it's live). | 2026-09-01 | pending profile |
