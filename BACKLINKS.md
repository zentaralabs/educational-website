...
| Qwoted signup | ✅ 2026-09-01 — account + Source profile complete. Bio (founder bio), website link https://www.wheretoapply.xyz (the backlink), location Kathmandu/Nepal, employment "Where To Apply", 10 relevant expertise hashtags (#StudyAbroad #InternationalStudents #StudentVisa #StudyInAustralia #SkilledMigration #Universityadmissions #Immigration #TuitionFees #HigherEducation #PublicPolicy — the auto-assigned legal/clinical/interior-design junk tags were removed). Onboarding topics: Government & Politics, Education & Career, Design/Culture/Lifestyle. Free tier = 7 pitch credits. Profile is public/indexable ("hide from search engines" left OFF). TODO: add a profile photo (brand logo works). | 2026-09-01 | app.qwoted.com/sources/roman-lama |
| Connectively signup | ⏳ 2026-09-01 — account + email verified. Expert profile appears on first "Answer" attempt; Claude filled it (Founder / Where To Apply / https://www.wheretoapply.xyz / verify email admin@ / verify link /about). BLOCKED: the LinkedIn field is REQUIRED and only accepts a personal linkedin.com/in/ URL — it rejects the company page. Roman has no personal LinkedIn. Next step: Roman creates a personal LinkedIn profile (~10 min, also useful for journalist credibility), then re-do the profile form (values above) and submit. Until then the account can't submit answers. Free tier = 3 answers/month. | 2026-09-01 | pending profile (LinkedIn blocker) |
