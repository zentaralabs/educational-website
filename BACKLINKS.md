...
- 2026-09-02 — Instagram: posted a new 9-frame carousel **"February or July intake: how to choose"** (scratchpad/intake-carousel.html + scratchpad/intake-images/, fact-checked vs /guides/february-vs-july-intake-in-australia). Post: instagram.com/p/Dcxk-_OEVSh/. Caption + first comment both posted. Bio link already set. Pinning the first comment is still app-only.
