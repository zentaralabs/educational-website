# Backlink plan — Where To Apply

Deliberately minimal. Two tracks, both low-effort, both legitimate. No comment
links, no bought lists, no automated posting, no education "directories" (that
space is almost all link farms — skipped on purpose).

Goal: help Google discover the site faster, earn a handful of real links, and
build brand presence in the places people check when they Google "wheretoapply".

---

## Reusable copy (paste into every submission)

- **Name:** Where To Apply
- **URL:** https://www.wheretoapply.xyz
- **Tagline (short):** Compare Australian universities, courses, fees, and student visas in one place.
- **One-liner (~60 chars):** Australian university & student-visa research for international students
- **Description (medium):**
  > Where To Apply is a free research platform for international students planning to study in Australia. It brings every Australian university's tuition, entry requirements, application deadlines, and scholarships into one structured, filterable database — plus plain-English guides to the student visa (subclass 500), post-study work options, and skilled migration, with a PR points calculator and a live SkillSelect invitation-round tracker. Every figure is sourced from an official university or government page and carries a "last verified" date.
- **Category:** Education / EdTech
- **Founder / maker:** Roman Lama
- **Location:** Nepal
- **Logo:** `public/icon.svg` (export a 512×512 PNG for sites that need raster)
- **Screenshots:** homepage, `/universities` (the filterable directory), `/visas/points-calculator`, `/deadlines`

---

## Track 1 — Directory & profile submissions
...
### Tier 2 — 5–10 min each, do in one batch

| Site | URL | Notes |
|---|---|---|
| SaaSHub | saashub.com/submit | Software directory; lists you among alternatives. |
| Uneed | uneed.best/submit-a-tool | Newer launch directory, active. |
| Fazier | fazier.com | PH-style launch board. |
| Peerlist Launchpad | peerlist.io/launchpad | Product launch feed. |
| Startup Stash | startupstash.com/add-startup/ | Curated startup resource list. |
| Tiny Launch / MicroLaunch | tinylaunch.com, microlaunch.net | Batch-submit; marginal but free. |
| AlternativeTo | alternativeto.net | Lower priority — weak fit (it's for software). Skip unless quick. |

### Tier 3 — local, explore yourself

You're in Nepal and will know these better than me: Nepali startup / tech
directories and "made in Nepal" product lists. Search "Nepal startup directory",
"Tech in Asia Nepal", local tech-community Facebook groups. Same reusable copy.

### Not a directory but do it now

- **LinkedIn** — create a Company Page for Where To Apply (not a backlink, but it's
  what people check, and it ranks for the brand name).
- **Google Business Profile** — skip. Not a local business.

---

## Track 2 — Journalist source requests (replaces HARO)

HARO shut down; Connectively (its successor) also shut down in Dec 2024. The live
options:

### Sign up (all free, ~15 min total)

1. **Source of Sources (SOS)** — https://sourceofsources.com — Peter Shankman's
...
4. **X / Bluesky** — follow and search **#journorequest** and **#PRrequest**.
   Free, real, and study-abroad / immigration queries come up regularly.

### Weekly workflow (~10 min)

1. Skim the SOS digests + Featured open questions.
2. Anything about: student visas, studying in Australia, international education,
   university costs, choosing a course/country, skilled migration → **forward it
   to me** (or paste the query into a session).
3. I draft the response — specific, quotable, 100–200 words, no fluff, one
   natural mention of Where To Apply and its data.
4. You paste it in and submit under your name.
5. One good placement (a real news / .edu article) beats 50 directory links.
...
| Crunchbase | ☐ | | |
| BetaList | ☐ | | |
| Indie Hackers product | ✅ 2026-08-30 | 2026-08-30 | indiehackers.com/product/where-to-apply |
...
## Guardrails (don't undo the work)

- Never post the link in blog comments, forum threads, or subreddit posts as a
  self-promo drop. Google's link-spam system devalues or penalizes these.
- Never buy an email list or mass-cold-email for links — it flags the sending
  domain as spam and hurts real deliverability.
- Reddit / forums: only ever a genuine, helpful answer to a question someone
  actually asked, posted by you, sparingly. That's outreach, not link-building,
  and it's a separate (later) effort.
- Volume is not the goal. 10 real links over 2 months beats 200 junk links.

---

# Appendix — Product Hunt launch kit

Draft copy + assets + logistics. Everything below is ready to use next session;
nothing here has been submitted yet.
...
1. `The research platform for studying in Australia` — 46 *(recommended: clean, positions it as a category)*
2. `Compare Australian universities, courses, fees & visas` — 53
3. `Everything you need to plan studying in Australia` — 48

### Topics (choose 3)
`Education` · `Education Technology` · `Travel`
(if a more specific one is offered — "Students", "Study abroad" — swap it in for Travel)

### Links
- Website: `https://www.wheretoapply.xyz`
- (optional) `https://www.wheretoapply.xyz/visas/points-calculator` as a "try this first" link

### Description (~260 chars show before "read more"; first sentence does the work)

> Where To Apply pulls every Australian university's tuition, entry requirements, application deadlines, and scholarships into one filterable database — then adds plain-English guides to the student visa (subclass 500), post-study work, and skilled migration. A PR points calculator and a live SkillSelect invitation-round tracker are built in. Every figure is sourced from an official university or government page and carries a "last verified" date. It's independent — not an agent, no paid placements.

## Maker's first comment

Post this the moment the launch goes live. It carries the launch — people upvote
makers who show up with a real story.

> Hi Product Hunt 👋
>
> I'm Roman, building this solo from Nepal.
>
> If you've ever researched studying abroad, you know the problem: the real details — this year's tuition, the actual application deadline, whether a course is CRICOS-registered, what the student visa costs — are scattered across hundreds of university pages, each formatted differently, each easy to miss a change on. The gap gets filled by agents (who have an incentive) and blog spam (which is thin and often out of date).
>
> Where To Apply is my attempt at the version I wish existed: a structured, queryable database of every Australian university — fees, entry requirements, English scores, intakes, deadlines, scholarships — that you can actually filter and compare. On top of the data sit plain-English guides to the parts people get stuck on: the subclass 500 student visa, the post-study work visa, and the skilled-migration points test (with a working points calculator and a round-by-round SkillSelect invitation tracker).
>
> Two things I care about:
> - **Every fact is sourced and dated.** There's a "last verified" date and a link to the official source on every figure. Immigration and fee info goes stale fast, so this is the whole point.
> - **It's independent.** No university pays for inclusion or a better write-up. I'm not an education agent and take no placement commissions.
>
> Australia is the full launch today. The data model already supports more countries — UK, Canada, others — once each gets the same fact-checking pass.
>
> What I'd love feedback on: if you've applied to study abroad (anywhere), what did you struggle to find, and what would have actually helped? And if you spot a number that looks wrong, tell me — I'll fix it and re-check the source.
>
> Thanks for taking a look. 🙏

## Gallery assets (build these before launch)

- **Thumbnail** — 240×240 PNG. The `icon.svg` mark on a solid brand background.
- **Image 1 / hero** — 1270×760. Homepage: the "Where should you apply?" hero with the 🇦🇺 scope line and search bar. This is the frame most people see.
- **Image 2** — `/universities` with a few filters active (state + tuition band). Shows the "structured database, not a blog" difference.
- **Image 3** — a university profile (e.g. Monash): the "At a glance" fact grid + deadlines + scholarships sections. Shows depth.
- **Image 4** — `/visas/points-calculator` mid-use, with a score showing.
- **Image 5** — `/deadlines` calendar view.
- **Image 6** — `/visas` hub: the "study-to-PR pathway" section + the comparison table.
- Optional **Image 7** — a close crop of a `LastVerified` line with a source link, captioned "every figure is sourced and dated".

Keep them clean — real screenshots, light theme, no heavy mockup frames. A short
...
- **Time:** go live at **12:01 AM Pacific**. PH's "day" resets then, so posting at 12:01 gives the full 24h on the leaderboard. In Nepal that's roughly **12:45–1:45 PM** (depending on US daylight saving). Use PH's **"Schedule"** feature to queue it in advance so you don't have to be up.
- **First comment:** posts automatically with the launch — make sure it's saved in the draft.
- **All day:** reply to every comment within minutes for the first few hours. Engagement (comments + upvotes) in the first 2–3 hours sets the daily rank.
- **Do NOT ask for upvotes** — against PH rules, and it can get the post removed. You *can* share "I'm live on Product Hunt today: [link]" on your own channels and let people decide.
- Line up **5–10 people** (friends, anyone in your network who's studied abroad) to genuinely check it out and leave a real comment during the launch window. Not a vote ring — real engagement from real accounts.

## Prep checklist (before the launch date)
...
1. ~~**F6S**~~ — ✅ DONE 2026-08-30. f6s.com/where-to-apply
2. ~~**Indie Hackers**~~ — ✅ DONE 2026-08-30. indiehackers.com/product/where-to-apply
   (Optional later: a genuine "building" story post in the IH community — skip unless it feels real.)
...
Note (co-drive gotcha): the in-app Browser pane does not share Chrome's login session
and Google OAuth is blocked inside it. Use the Claude-in-Chrome tools against Roman's
real Chrome once he's logged in there — that worked for both F6S and IH.
...
| F6S | ✅ 2026-08-30 — page + logo + About + tagline + 5 market tags + founder + website/LinkedIn links (70% strength) | 2026-08-30 | f6s.com/where-to-apply |
...
- 2026-09-02 — Instagram + Facebook + LinkedIn: pushed the **"February or July intake"** content to all three.
  - Instagram: new 9-frame carousel (scratchpad/intake-carousel.html + scratchpad/intake-images/, fact-checked vs /guides/february-vs-july-intake-in-australia). Post: instagram.com/p/Dcxk-_OEVSh/. Caption + first comment both posted. Bio link already set. Pinning the first comment is still app-only.
  - Facebook: 9-photo album (same frames) + hook caption + guide URL + 7 hashtags, posted as the Page. Note: FB shows the photos as a collage grid (not swipeable); the URL sits as plain clickable text (no preview card when photos are attached). GOTCHA: after Share, FB shows a "Hosting an event?" upsell (because the copy mentions months) — click "Publish Original Post", not "Continue". It publishes once despite a confusing reopened composer.
  - LinkedIn: text post + auto-generated link preview card for the guide (LinkedIn detected the URL and built the card itself) + 3 hashtags, as the Company Page (id 143591071, admin URL uses the id not the "wheretoapply" slug which 404s). No image carousel on LinkedIn — the link card is the LinkedIn-native format and the FB post carries the visual.
  - **IG profile state 2026-09-02:** 2 posts, 0 followers, 0 following. Post 1 = the "The Agent Doesn't Work For You" carousel (was already live when this session started — built 09-01, apparently posted then too). Post 2 = the new intake carousel. The 3 screenshot posts logged for 09-01 are NOT on the profile.
