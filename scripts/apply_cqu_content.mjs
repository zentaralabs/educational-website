...
// english_requirements) to CQUniversity program rows during the build-out
...
//
//   node scripts/apply_cqu_content.mjs scripts/data/_cqu_fix.json          # dry run
//   node scripts/apply_cqu_content.mjs scripts/data/_cqu_fix.json --commit
