...
const visas = [
  {
    ...
    stream: null,
    short_description:
      "How to apply for the subclass 500 student visa: eligibility, the Genuine Student requirement, cost, application steps, and the path to permanent residence after you graduate.",
    summary:
    ...
    content:
      "## How to apply for the subclass 500\n\n1. **Get your Confirmation of Enrolment (CoE).** Accept your offer and pay any required deposit with your CRICOS-registered provider first; they issue the CoE through PRISMS, and you cannot lodge the visa application without it.\n2. **Buy Overseas Student Health Cover (OSHC)** for the full length of your intended stay, matching your CoE end date. Most providers can arrange this for you, or you can buy it directly from an OSHC provider.\n3. **Prepare your Genuine Student statement and evidence.** Address why this course, at this level, fits your study and career background, and gather proof of funds for tuition, travel, and living costs, plus any ties to your home country you want to reference.\n4. **Create an ImmiAccount and lodge online.** All subclass 500 applications go through ImmiAccount. Upload your CoE, passport, financial evidence, OSHC policy, and Genuine Student statement, then pay the base application charge.\n5. **Complete biometrics if requested.** Home Affairs will tell you if and where to provide fingerprints and a photo at a visa application centre.\n6. **Respond quickly to any request for more information.** A case officer may ask for extra documents or an interview; delays in replying are one of the most common causes of a slower decision.\n7. **Check your outcome in ImmiAccount.** The subclass 500 has no physical label: your visa is linked electronically to your passport, and the grant notice is the document to keep.\n\n## What the subclass 500 covers\n\nOne student visa covers one primary course of study, plus any pre-requisite courses packaged with it. If you change to a course at a lower AQF level than the one you were granted the visa for, you generally need a new visa.\n\n## Working on a student visa\n\nYou can start working once your course begins, not before. The 48-hour fortnightly cap applies while your course is in session. Hours worked in a registered course's mandatory work placement do not count toward the cap.\n\n## Bringing family\n\nYou can include your partner and dependent children. Family members over school age who want to work face the same 48-hour cap, or no cap if you are studying a masters or doctorate.\n\n## How long it lasts\n\nFor courses longer than 10 months finishing in November or December, the visa usually runs to 15 March the next year. Shorter courses get a one to three month buffer after the course end date.\n\n## Common reasons applications fail\n\nThin Genuine Student statements, unexplained gaps in study history, funds that appear only days before applying, and course choices that do not build on previous study are the usual culprits.",
    source_urls: [
