...
// Archive Kaplan Business School program rows with cited evidence, writing BOTH
// status='archived' and discontinued_note (copied from icms_archive.mjs pattern;
// a past bug in archive_programs.mjs silently dropped discontinued_note from writes).
//
//   node scripts/kbs_archive.mjs scripts/data/kbs_archive_list.json          # dry run
//   node scripts/kbs_archive.mjs scripts/data/kbs_archive_list.json --commit
//
...
const logFile = path.join("scripts", "data", "kbs-archived.json");
