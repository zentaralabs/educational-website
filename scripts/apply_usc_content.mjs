...
// english_requirements, source_url) to University of the Sunshine Coast published
// programs, sourced live from unisc.edu.au during the 2026-09-19 build-out sprint.
//
//   node scripts/apply_usc_content.mjs /tmp/usc_updates.json          # dry run
//   node scripts/apply_usc_content.mjs /tmp/usc_updates.json --commit
