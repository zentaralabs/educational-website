...
const guides = [
  ...
  },
  {
    ...
    title: "Training visa (subclass 407) vs the Skills in Demand visa (subclass 482)",
    category: "country-guide",
    country: "AU",
    excerpt:
      "They sound alike and both need a sponsor, but the 407 is for structured training and the 482 is for a skilled job. Only one leads to permanent residence.",
    content:
