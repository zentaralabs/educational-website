...
// "Where To Apply editorial team" author. Used for pieces the site publishes
// under the masthead rather than a single named byline. A guide entry sets
...
const guides = [
  ...
  {
    slug: "training-visa-407-vs-skills-in-demand-visa-482",
    title: "407 Training visa vs 482 Skills in Demand visa: how to choose",
    category: "country-guide",
    country: "AU",
    excerpt:
      "The subclass 407 Training visa is for structured training, the 482 Skills in Demand visa is for a skilled job, and only one leads to permanent residence.",
    content:
      "Two of Australia's employer-linked temporary visas get confused because the names sound similar and both need an Australian organisation to sponsor you. They are not alternatives. The [Skills in Demand visa (subclass 482)](/visas/skills-in-demand-482) is for a real skilled job. The [Training visa (subclass 407)](/visas/training-visa-407) is for a structured training program, not employment. If you are a graduate weighing your options after a [485](/visas/temporary-graduate-485), the 482 is almost always the one you mean.\n\n## 407 and 482 at a glance\n\n| | Training visa (407) | Skills in Demand visa (482) |\n| --- | --- | --- |\n| Purpose | Workplace-based occupational training | A skilled job the employer cannot fill locally |\n| Sponsor | An approved temporary activities sponsor | An approved standard business sponsor |\n| What you can do | Only the nominated training activities | Full-time work for your sponsor in the nominated occupation |\n| Pay | No salary floor set by the visa, often an allowance | At or above the stream income threshold and the market rate |\n| Length | Up to 2 years | Up to 4 years, 5 for Hong Kong passport holders |\n| Main applicant fee | From AUD 535 | From AUD 4,015 |\n| Leads to permanent residence | No | Yes, through the [186](/visas/employer-nomination-scheme-186) |\n\n## What the 407 is actually for\n\nThe 407 covers three kinds of training, and your sponsor has to nominate you for one of them:\n\n- **Training for registration or licensing** that you need to work in an occupation, either in Australia or back home.\n- **Training to improve your skills** in an occupation on the list of eligible skilled occupations. You need the equivalent of at least 12 months of full-time experience in that occupation, gained in the 24 months before the nomination is lodged.\n- **Capacity building overseas**: practical training tied to an overseas qualification (up to 6 months), government-supported training, or a professional development program run for staff sent by an overseas employer.\n\nThe 407 is not for ongoing work in Australia. The main visa holder can only take part in the nominated training and cannot do other paid work. Family members can be included on the application, and they can work up to 40 hours a fortnight, which is less than a student visa allows.\n\n## What the 482 is actually for\n\nThe 482 lets an approved business sponsor you into a genuine skilled position for up to four years. Since 7 December 2024 it has had three streams:\n\n- **Core Skills**: your occupation is on the Core Skills Occupation List and the salary is at or above the Core Skills Income Threshold, which is AUD 79,423 for nominations lodged between 1 July 2026 and 30 June 2027.\n- **Specialist Skills**: no occupation list, but the salary must be at or above the Specialist Skills Income Threshold of AUD 146,576 for the same period.\n- **Labour Agreement**: for employers with a negotiated agreement covering a specific sector.\n\nYou need one year of relevant full-time work experience in the last five years, and the English level for your stream, generally IELTS 5.0 overall for Core Skills. Your employer pays the Skilling Australians Fund levy and the nomination fee.\n\n## The part that matters: permanent residence\n\nEvery 482 stream now counts toward permanent residence. After two years working for your sponsor you can generally be nominated for the [subclass 186](/visas/employer-nomination-scheme-186) through its Temporary Residence Transition stream. Time on the 482 also counts toward the residence requirement for other routes. See [the study-to-PR pathway](/guides/study-to-permanent-residence-pathway-australia) for how this fits after graduation.\n\nThe 407 has no equivalent. It is training. You finish, then you leave, unless you separately qualify for another visa.\n\n## Which one applies to you\n\n- You have a job offer from an Australian employer, the role matches your skills, and it pays above the threshold: that is the **482**.\n- You need supervised hours or a placement to get registered in your profession, and an approved sponsor will host you: the **407** registration stream.\n- You are enrolled at a university overseas and need an Australian placement to finish your degree: the **407** overseas-qualification stream, up to 6 months.\n- You want to work in Australia and build toward permanent residence: the **482**, or one of the skilled visas if your [points score](/guides/how-the-australian-points-test-works) is competitive. The 407 does not move you toward staying.\n\nNeither visa is something you can lodge on your own. The sponsor and the nomination have to be approved first, and for the 482 the position and the pay do most of the work.\n\n## Can I move from a 407 to a 482?\n\nYes, but there is no automatic link. You would need an employer to sponsor you into a skilled position and to meet the 482 requirements in your own right, including the one year of relevant experience. Time spent on a 407 does not count toward the two years with a sponsor that the 186 transition needs.\n\n## Does the 407 let me work while I train?\n\nNo. The primary 407 holder can only take part in the approved training activities. If you need general work rights, the 407 is the wrong visa.\n\n## Is the 482 open to recent graduates?\n\nOften, yes. The experience requirement is one year of relevant full-time work in the last five years, which many people reach during their two years on a post-study work visa. The harder part is finding an employer willing to sponsor you and a salary that clears the threshold for your stream.\n\n## Does the 407 lead to permanent residence?\n\nNo. The 407 is a temporary training visa with no permanent residence stream of its own. To stay you would move onto another visa, most often the 482 and then the 186 after two years with a sponsor, or qualify for a skilled visa in your own right. The training and Australian experience you gain can help those later applications, but the 407 itself does not count toward them.",
    sources: [
...
Not on its own. Priority 3 means the university filled its international allocation quickly, which often reflects strong demand. The tier is about queue position for visa processing in a given year, not teaching or graduate outcomes. Judge the university on its profile, fees and course, and treat the priority status as a timing constraint to plan around.`,
  ...
  {
    slug: "cost-of-studying-in-australia-from-india",
    title: "The cost of studying in Australia from India",
    authorId: EDITORIAL_AUTHOR_ID,
    lastVerifiedAt: "2026-09-07",
    category: "country-guide",
    country: "AU",
    excerpt:
      "A first-year budget in rupees and dollars, how much money the student visa expects you to show, how the education loan works, and what higher visa scrutiny means for Indian applicants.",
    content:
      "A first year of study in Australia costs an Indian student roughly AUD 40,000 to AUD 75,000 all in. At a mid-market rate of about INR 68 to the dollar in September 2026, that is between INR 27 lakh and INR 51 lakh. Rates move and your bank adds a margin, so treat the rupee figures here as a guide.\n\nThis page breaks the number down, covers the funds the [student visa](/visas/student-500) asks you to prove, and explains how the education loan and the higher visa scrutiny work for Indian applicants.\n\n## What the first year costs\n\n| Item | Typical range (AUD) | Notes |\n| --- | --- | --- |\n| Tuition, first year | 28,000 to 48,000 | Lower at regional and newer universities, higher at the Group of Eight |\n| Living costs | 24,000 to 33,000 | The visa minimum is a fixed figure, see below; your real spend depends on the city |\n| Overseas Student Health Cover | 550 to 800 | Single 12-month policy, more for a couple or family |\n| Student visa charge | 2,500 | Paid once, not refunded if the visa is refused |\n| One-way airfare | 600 to 1,200 | Varies by season and route |\n\nAdd an English test and document costs on top. Tuition and living costs are what move the total, so the city and university decide most of it.\n\n## The money the visa wants you to show\n\nFor a student visa lodged from India you generally need to show funds, or a parent or partner income, covering your first year. The Department of Home Affairs sets the living-cost figure it accepts:\n\n- AUD 29,710 for you, for 12 months\n- AUD 10,394 for a partner who comes with you\n- AUD 4,449 for each child who comes with you\n\nThe calculation also counts your first 12 months of tuition and about AUD 2,000 for travel. As an alternative to savings, you can show that a parent or partner earned at least AUD 87,856 in the 12 months before you apply, or AUD 102,500 if family members come with you.\n\nSince January 2026, India sits at the highest student-visa evidence level. A case officer will look closely at the source of your funds. A single-day bank balance certificate is not enough. You need statements showing the money accumulating, a loan sanction letter with a disbursement schedule, and usually around six months of account history. The [proving your funds guide](/guides/proving-funds-for-an-australian-student-visa) covers what counts.\n\n## How the education loan works\n\nMost Indian students fund the course with an education loan. Under the Indian Banks' Association model scheme, loans up to around INR 7.5 lakh can be unsecured, and larger loans, which most Australia budgets need, require collateral such as property or fixed deposits. Repayment usually begins 6 to 12 months after the course ends, and interest paid on an education loan is deductible under Section 80E for up to eight years. Public-sector banks and non-bank lenders both offer these loans on different terms. Limits, margins, and collateral rules change, so confirm the current position with the bank before you plan around a figure.\n\nFor the visa, the loan needs to be from a financial institution and disbursed according to its agreement. If any money is paid out before the visa decision, give Home Affairs the loan terms and the full amount you will receive.\n\n## Agent-only universities and earlier deadlines\n\nSeveral universities, particularly in Western Australia, only accept applications from Indian citizens through an authorised agent, and some close their applications weeks earlier for higher-scrutiny countries. Check each university's how-to-apply page. The [India country guide](/international/india) has the detail, and [applying without an agent](/guides/applying-to-australian-universities-without-an-agent) explains where direct application is still allowed.\n\n## The city changes the number\n\nAdelaide, Perth, and regional campuses sit at the lower end of tuition and rent. Sydney and Melbourne are the most expensive. Studying in a [regional area](/guides/choosing-a-regional-area-to-study-in-australia) also adds points toward a later skilled visa. Compare the [most affordable universities](/best/affordable-australian-universities-for-international-students) and [living costs by city](/cost-of-living).\n\n## After you graduate\n\nThe [485 graduate visa](/guides/temporary-graduate-visa-485-guide) gives two to three years of work rights after you finish, and the [study-to-permanent-residence pathway](/guides/study-to-permanent-residence-pathway-australia) explains how that can lead to a skilled visa.\n\n## How much does it cost to study in Australia from India?\n\nBudget AUD 40,000 to AUD 75,000 for the first year, roughly INR 27 lakh to INR 51 lakh at September 2026 rates. Tuition is AUD 28,000 to AUD 48,000, living costs are AUD 24,000 to AUD 33,000, and the visa, health cover, and flights add a few thousand more.\n\n## How much money do I need to show for an Australian student visa from India?\n\nEnough to cover 12 months of living costs at the Home Affairs figure of AUD 29,710, plus your first year of tuition and about AUD 2,000 for travel. You can instead show a parent or partner income of at least AUD 87,856 over the prior 12 months. Because India is at evidence level 3, you must also show how the funds were built up, with statement history or a disbursed loan, not a one-day certificate.\n\n## Can I use an education loan for the Australian student visa?\n\nYes. A loan from a financial institution counts as evidence of funds. It needs to be disbursed according to its agreement, and you should give Home Affairs the loan terms and the total amount payable. Loans above roughly INR 7.5 lakh usually need collateral.\n\n## Do Indian students have to apply through an agent?\n\nSome universities require it, mainly in Western Australia, and a few set earlier deadlines for higher-scrutiny countries. Others accept direct applications. Check the university's how-to-apply page before you start.\n\n## Is it cheaper to study in a regional Australian city?\n\nUsually. Tuition and rent are both lower in Adelaide, Perth, and regional campuses, and regional study also earns points toward a later skilled visa.",
    sources: [
      "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/student-500", "https://www.studyaustralia.gov.au/",
    ],
  },
  {
    slug: "cost-of-studying-in-australia-from-nepal",
    title: "The cost of studying in Australia from Nepal",
    authorId: EDITORIAL_AUTHOR_ID,
    lastVerifiedAt: "2026-09-07",
    category: "country-guide",
    country: "AU",
    excerpt:
      "A first-year budget in rupees and dollars, the No Objection Certificate, how much money the student visa expects you to show, and how Nepali families usually fund it.",
    content:
      "A first year of study in Australia costs a Nepali student roughly AUD 40,000 to AUD 70,000 all in. At a mid-market rate of about NPR 109 to the dollar in September 2026, that is somewhere between NPR 44 lakh and NPR 76 lakh. Exchange rates move and your bank will add a margin, so treat every rupee figure here as a guide, not a quote.\n\nThis page breaks the number down, explains the money the [student visa](/visas/student-500) asks you to prove, and covers the two things that are specific to Nepal: the No Objection Certificate, and the higher visa scrutiny that came in at the start of 2026.\n\n## What the first year costs\n\n| Item | Typical range (AUD) | Notes |\n| --- | --- | --- |\n| Tuition, first year | 28,000 to 45,000 | Lower at regional and newer universities, higher at the Group of Eight |\n| Living costs | 24,000 to 33,000 | The visa minimum is a fixed figure, see below; your real spend depends on the city |\n| Overseas Student Health Cover | 550 to 800 | Single 12-month policy, more for a couple or family |\n| Student visa charge | 2,500 | Paid once, not refunded if the visa is refused |\n| One-way airfare | 700 to 1,400 | Varies by season and route |\n| No Objection Certificate | small government fee | Paid to Nepal's Ministry of Education |\n\nAdd an English test and document costs on top. The tuition and living-cost lines are what move the total, so the city and university you choose matter more than anything else on the list.\n\n## The money the visa wants you to show\n\nFor a student visa lodged from Nepal you generally need to show funds, or a parent or partner income, that covers your first year. The Department of Home Affairs sets the living-cost figure it will accept:\n\n- AUD 29,710 for you, for 12 months\n- AUD 10,394 for a partner who comes with you\n- AUD 4,449 for each child who comes with you\n\nOn top of that, the calculation counts your first 12 months of tuition and about AUD 2,000 for travel. As an alternative to showing savings, you can show that a parent or partner earned at least AUD 87,856 in the 12 months before you apply, or AUD 102,500 if family members come with you.\n\nSince January 2026, Nepal sits at the highest student-visa evidence level, so a case officer will look closely at where the money came from. A one-day bank balance certificate is not enough on its own. You need statements that show the funds building up over time, or a loan that has actually been disbursed under its agreement. The [proving your funds](/guides/proving-funds-for-an-australian-student-visa) and [moving money to Australia](/guides/moving-money-to-australia-for-the-student-visa) guides go into this in detail.\n\n## The No Objection Certificate\n\nBefore a Nepali bank will remit your tuition abroad, and as part of the visa application, you need a No Objection Certificate from the Ministry of Education, Science and Technology. You apply for it yourself online at noc.moest.gov.np once you have your offer letter. It carries a small government fee and is usually issued within about a week. No agent needs to charge extra to process or speed it up. The [Nepal country guide](/international/nepal) covers the wider application process, including which universities require you to apply through an authorised agent.\n\n## How Nepali families usually fund it\n\nMost families use a mix: savings, an education loan from a Nepali bank secured against property, the sale of land, and support from relatives already working abroad. Loan rates and collateral rules vary between banks and change often, so confirm the current terms directly rather than relying on an agent's summary. Whatever the source, keep the paper trail, because at evidence level 3 the visa turns on being able to explain it.\n\n## The city changes the number\n\nAdelaide, Perth, and the regional campuses sit at the lower end of both tuition and rent. Sydney and Melbourne are the most expensive. Studying in a [regional area](/guides/choosing-a-regional-area-to-study-in-australia) also adds points toward a later skilled visa. Compare the [most affordable universities](/best/affordable-australian-universities-for-international-students) and [living costs by city](/cost-of-living) before you fix on a place.\n\n## After you graduate\n\nThe costs above buy the first year. If your plan is to work and stay, the [485 graduate visa](/guides/temporary-graduate-visa-485-guide) gives two to three years of work rights after you finish, and the [study-to-permanent-residence pathway](/guides/study-to-permanent-residence-pathway-australia) explains how that leads to a skilled visa.\n\n## How much does it cost to study in Australia from Nepal?\n\nBudget AUD 40,000 to AUD 70,000 for the first year, which is roughly NPR 44 lakh to NPR 76 lakh at September 2026 rates. Tuition is AUD 28,000 to AUD 45,000, living costs are AUD 24,000 to AUD 33,000, and the visa, health cover, and flights add a few thousand more. Regional cities and newer universities sit at the lower end.\n\n## How much bank balance do I need for an Australian student visa from Nepal?\n\nEnough to cover 12 months of living costs at the Home Affairs figure of AUD 29,710, plus your first year of tuition and about AUD 2,000 for travel. You can instead show a parent or partner income of at least AUD 87,856 over the prior 12 months. Because Nepal is at evidence level 3, you must also show how the money was accumulated, not just a single balance certificate.\n\n## Do I need a No Objection Certificate to study in Australia?\n\nYes. Nepal's Ministry of Education issues it online, and you need it before a Nepali bank will send your tuition abroad and as part of the visa application. Apply for it yourself after you receive your university offer.\n\n## Can I get an education loan in Nepal for study in Australia?\n\nYes. Nepali banks lend for overseas study, usually secured against property. Rates, limits, and collateral requirements vary between banks and change often, so confirm the current terms with the bank directly. Any loan used for the visa needs to be disbursed according to its agreement.\n\n## Is it cheaper to study in a regional Australian city?\n\nUsually. Tuition and rent are both lower in Adelaide, Perth, and regional campuses than in Sydney or Melbourne, and regional study also earns points toward a later skilled visa.",
    sources: [
      "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/student-500", "https://noc.moest.gov.np/", "https://www.studyaustralia.gov.au/",
    ],
  },
  {
    slug: "australian-student-visa-from-india",
    title: "The Australian student visa from India, step by step",
    authorId: EDITORIAL_AUTHOR_ID,
    lastVerifiedAt: "2026-09-07",
    category: "country-guide",
    country: "AU",
    excerpt:
      "The subclass 500 application for an Indian citizen: the Evidence Level 3 document set, the education loan, the Genuine Student responses, processing, and what a refusal means.",
    content:
      "You have your offer and your Confirmation of Enrolment. The next step is the [subclass 500 student visa](/visas/student-500). This page walks through the application as an Indian citizen lodges it, including the higher document scrutiny that has applied since January 2026 and how the education loan fits the financial requirement.\n\n## Before you lodge\n\nYou need three things in place:\n\n- A valid **Confirmation of Enrolment (CoE)** from your provider, still valid when the visa is decided.\n- **Overseas Student Health Cover (OSHC)** for the full length of the visa. See [OSHC health cover](/guides/oshc-health-cover-for-international-students).\n- A **passport** valid well beyond your intended stay.\n\n## India is at Evidence Level 3\n\nSince January 2026, India has been at the highest student-visa evidence level, alongside Nepal, Bangladesh, and Bhutan. You attach the full financial and academic evidence with the application rather than waiting to be asked. An incomplete application at this level can be refused without the department requesting more from you.\n\nRun the **Document Checklist Tool** on the Home Affairs website with your Indian passport and your provider before you gather anything. It is updated twice a year, so check it again in the week before you lodge. The [documents checklist guide](/guides/documents-checklist-for-an-australian-student-visa) covers the common core.\n\n## Proving you have genuine access to the money\n\nYou must show funds covering 12 months of living costs (AUD 29,710), your first year of tuition, and about AUD 2,000 for travel. Alternatively, show a parent or partner earned at least AUD 87,856 in the 12 months before you apply.\n\nAt Evidence Level 3, the department looks at whether the money is genuinely available to you:\n\n- **Bank statements** covering three to six months, showing the balance accumulating rather than a single-day certificate\n- **Source of funds**: salary evidence, property documents, fixed deposit certificates, or an education loan\n- If a parent or relative is funding you, their income and employment proof plus proof of the relationship\n\nSee [proving your funds](/guides/proving-funds-for-an-australian-student-visa).\n\n## How the education loan works for the visa\n\nMost Indian students fund the course with an education loan, and a loan from a financial institution counts as evidence of funds. What the department wants to see:\n\n- A **sanction letter** stating the approved amount and the terms\n- A **disbursement schedule**, or evidence the loan has been disbursed according to the agreement\n- If any money is paid out before the visa decision, the loan terms and the full amount you will receive\n\nUnder the Indian Banks' Association model scheme, loans up to around INR 7.5 lakh can be unsecured, and larger loans, which most Australia budgets require, need collateral such as property or fixed deposits. Repayment usually begins 6 to 12 months after the course ends. These terms vary by lender and change, so confirm the current position with the bank. The [cost of studying in Australia from India](/guides/cost-of-studying-in-australia-from-india) guide covers the loan in more detail.\n\n## The Genuine Student responses\n\nThe application form asks four questions about your circumstances, why this course and provider, and how it benefits you. Each answer is capped at 150 words and must be in English. Back your answers with evidence: academic transcripts, employment letters, and evidence of ties to India. See [writing your Genuine Student statement](/guides/genuine-student-requirement-how-to-write-your-statement) and [worked examples](/guides/genuine-student-statement-examples).\n\n## Health and character\n\n- A **health examination** with a panel physician, either after you lodge or beforehand.\n- A **police certificate** from India, and from any other country you have lived in for 12 months or more in the last 10 years.\n\n## Applying through an agent\n\nSeveral universities, particularly in Western Australia, only accept applications from Indian citizens through an authorised agent, and some set earlier deadlines for higher-scrutiny countries. Check each university's how-to-apply page. Where direct application is allowed, [applying without an agent](/guides/applying-to-australian-universities-without-an-agent) explains the process, and the [India country guide](/international/india) has the country detail.\n\n## Processing and priority\n\nOffshore student visa applications lodged on or after 14 November 2025 are processed under Ministerial Direction 115. Your place in the queue depends on how full your provider's intake allocation is on the day you lodge. A provider below 80 percent of its allocation is Priority 1, aimed at one to four weeks; one that has exceeded its allocation can sit at nine to twelve weeks. Check your provider first with [check a university's visa priority](/guides/check-australian-university-student-visa-priority).\n\n## If your application is refused\n\nThere is usually no merits review for a student visa refused while you are outside Australia. Your option is to lodge again, directly addressing the reason in the refusal letter. See [what to do if your student visa is refused](/guides/what-to-do-if-your-student-visa-is-refused).\n\nIf the refusal cites Public Interest Criterion 4020, which covers false or misleading information or documents, take advice from a registered migration agent before reapplying. It can carry a three-year exclusion during which most Australian visas are refused.\n\nThe most common grounds for refusal of Indian applications are financial capacity not shown to be genuinely accessible, the Genuine Student requirement not being satisfied, and document integrity concerns.\n\n## After the grant\n\nYour visa carries conditions: a work limit of 48 hours per fortnight while your course is in session, maintaining enrolment and course progress, and keeping OSHC for the length of the visa. See [working while you study](/guides/working-while-you-study-in-australia) and the [first month checklist](/guides/first-month-in-australia-international-student-checklist).\n\n## How long does an Australian student visa take from India?\n\nIt depends on your provider. Under Ministerial Direction 115, an application to a provider below 80 percent of its intake allocation is aimed at one to four weeks, while one to a provider that has exceeded its allocation can take nine to twelve weeks. Processing slows before the February and July intakes, so lodge early.\n\n## Can I lodge the visa before my education loan is disbursed?\n\nYou can lodge with a sanction letter and a disbursement schedule, but at Evidence Level 3 the department wants to see that the funds are genuinely available. Evidence of actual disbursement is the strongest proof. If any of the loan is paid out before the decision, give the department the loan terms and the total amount payable.\n\n## Can I appeal an Australian student visa refusal from India?\n\nGenerally no. Applications refused while you are outside Australia usually have no merits review. Lodge a fresh application addressing the exact reasons given. If the refusal cites Public Interest Criterion 4020, take migration advice first, because it can carry a three-year exclusion.\n\n## What is the most common reason Indian student visas are refused?\n\nFinancial capacity that is not shown to be genuinely accessible, followed by the Genuine Student requirement not being met, and concerns about document integrity.",
    sources: [
      "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/student-500",
      "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/student-500/genuine-student-requirement",
  ...
  {
    slug: "australian-student-visa-from-nepal",
    title: "The Australian student visa from Nepal, step by step",
    authorId: EDITORIAL_AUTHOR_ID,
    lastVerifiedAt: "2026-09-07",
    category: "country-guide",
    country: "AU",
    excerpt:
      "The subclass 500 application for a Nepali citizen: the No Objection Certificate, the Evidence Level 3 document set, the Genuine Student responses, processing, and what a refusal means.",
    content:
      "You have your offer and your Confirmation of Enrolment. The next step is the [subclass 500 student visa](/visas/student-500). This page walks through the application as a Nepali citizen lodges it, including the two things specific to Nepal: the No Objection Certificate, and the higher document scrutiny that has applied since January 2026.\n\n## Before you lodge\n\nYou need three things in place:\n\n- A valid **Confirmation of Enrolment (CoE)** from your provider. It must still be valid when the visa is decided.\n- **Overseas Student Health Cover (OSHC)** for the full length of the visa, not just the course. See [OSHC health cover](/guides/oshc-health-cover-for-international-students).\n- A **passport** valid well beyond your intended stay.\n\n## Nepal is at Evidence Level 3\n\nSince January 2026, Nepal has been at the highest student-visa evidence level, alongside India, Bangladesh, and Bhutan. In practice this means you attach the full financial and academic evidence with the application rather than being asked for it later. An incomplete application at this level can be refused without the department coming back to you for more.\n\nRun the **Document Checklist Tool** on the Home Affairs website with your Nepali passport and your provider before you gather anything. It returns your exact list and is updated twice a year, so check it again in the week before you lodge. The [documents checklist guide](/guides/documents-checklist-for-an-australian-student-visa) covers the common core.\n\n## The No Objection Certificate\n\nBefore a Nepali bank will remit your tuition abroad, and as part of the visa, you need a No Objection Certificate from the Ministry of Education, Science and Technology. Apply for it yourself online at noc.moest.gov.np once you have your offer letter. It carries a small government fee and is usually issued within about a week. No agent needs to charge extra to process it. The [Nepal country guide](/international/nepal) covers the wider application process and which universities require an authorised agent for Nepali citizens.\n\n## Proving you have genuine access to the money\n\nThis is where most Nepali applications are decided. You must show funds covering 12 months of living costs (AUD 29,710), your first year of tuition, and about AUD 2,000 for travel. Alternatively you can show a parent or partner earned at least AUD 87,856 in the 12 months before you apply.\n\nAt Evidence Level 3, showing the money is not enough. You must show it is genuinely yours to use:\n\n- **Bank statements** covering three to six months, showing the balance building up, not a single-day balance certificate\n- **Source of funds**: salary evidence, a property sale deed, fixed deposit certificates, or a sanctioned and disbursed education loan\n- If a relative is funding you, their income and employment proof plus a document proving the relationship\n\nThe [proving your funds](/guides/proving-funds-for-an-australian-student-visa) and [moving money to Australia](/guides/moving-money-to-australia-for-the-student-visa) guides go into the detail. A large deposit that appears a week before you lodge, with no history behind it, is the single most common reason a Nepali application is questioned.\n\n## The Genuine Student responses\n\nThe application form asks four questions about your circumstances, why this course and provider, and how it benefits you. Each answer is capped at 150 words and must be in English. The department gives more weight to answers backed by evidence, such as academic transcripts, employment letters, and evidence of ties to Nepal. See [writing your Genuine Student statement](/guides/genuine-student-requirement-how-to-write-your-statement) and [worked examples](/guides/genuine-student-statement-examples).\n\n## Health and character\n\n- A **health examination** with a panel physician. You will be directed to book this after you lodge, or you can do it beforehand.\n- A **police certificate** from Nepal, and from any other country you have lived in for 12 months or more in the last 10 years.\n\n## Processing and priority\n\nOffshore student visa applications lodged on or after 14 November 2025 are processed under Ministerial Direction 115. Your place in the queue depends on how full your provider's intake allocation is on the day you lodge, not on anything about you. A provider below 80 percent of its allocation is Priority 1, with processing aimed at one to four weeks; one that has passed its allocation can sit at nine to twelve weeks. Check your provider's status first with [check a university's visa priority](/guides/check-australian-university-student-visa-priority).\n\n## If your application is refused\n\nThere is usually no merits review for a student visa refused while you are outside Australia. Your realistic option is to lodge again, directly addressing the specific reason in the refusal letter. A second application that repeats the first will be refused the same way. The [what to do if your student visa is refused](/guides/what-to-do-if-your-student-visa-is-refused) guide sets out the process.\n\nIf the refusal cites Public Interest Criterion 4020, which covers false or misleading information or documents, get advice from a registered migration agent before doing anything. That criterion can carry a three-year exclusion during which most Australian visas are refused.\n\nThe most common grounds for refusal of Nepali applications are funds that are not shown to be genuinely accessible, the Genuine Student requirement not being satisfied, and document integrity concerns.\n\n## After the grant\n\nYour visa carries conditions. The main ones are a work limit of 48 hours per fortnight while your course is in session, maintaining enrolment and course progress, and keeping OSHC for the length of the visa. See [working while you study](/guides/working-while-you-study-in-australia) and the [first month checklist](/guides/first-month-in-australia-international-student-checklist).\n\n## How long does an Australian student visa take from Nepal?\n\nIt depends on your provider, not on you. Under Ministerial Direction 115, an application to a provider that is below 80 percent of its intake allocation is aimed at one to four weeks. One to a provider that has exceeded its allocation can take nine to twelve weeks. Processing also slows in the busy months before the February and July intakes, so lodge early.\n\n## Can I appeal an Australian student visa refusal from Nepal?\n\nGenerally no. Applications refused while you are outside Australia usually have no merits review. Your option is to lodge a fresh application that addresses the exact reasons in the refusal letter. If the refusal cites Public Interest Criterion 4020, take migration advice before reapplying, because it can carry a three-year exclusion.\n\n## What is the most common reason Nepali student visas are refused?\n\nFinancial capacity that is not shown to be genuinely accessible, such as a large deposit with no history behind it, followed by the Genuine Student requirement not being met, and concerns about the integrity of documents.\n\n## Do I need the No Objection Certificate before the visa?\n\nYes. You need it before a Nepali bank will send your tuition abroad, and it forms part of the visa application. Apply for it yourself online at the Ministry of Education portal once you have your university offer.",
    sources: [
      "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/student-500",
      "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/student-500/genuine-student-requirement",
      "https://noc.moest.gov.np/",
  ...
  {
    slug: "cheapest-australian-university-tuition-vs-total-cost",
    title: "Why the cheapest tuition is rarely the cheapest degree",
    authorId: EDITORIAL_AUTHOR_ID,
    lastVerifiedAt: "2026-09-07",
    category: "how-to",
    country: "AU",
    excerpt:
      "The tuition sticker price is the number people rank on. Four other things move the real cost of an Australian degree more than the tuition rank does.",
    content:
      "Search \"cheapest university in Australia\" and you get lists ranked on one number: the international tuition fee. That number matters, but it is not what decides the cost of your degree. Four other things move the total more, and they are the reason the university with the lower fee often costs you more in the end.\n\n## Living costs usually outweigh the tuition gap\n\nA year of living costs in Australia runs roughly AUD 24,000 to AUD 33,000, and the student visa alone requires you to show AUD 29,710. For most students that is a bigger line than the difference in tuition between two universities. Rent is the swing factor, and it is a city decision, not a university one.\n\nA university in Sydney with tuition AUD 3,000 lower than one in Adelaide can still cost you more over a year, because Sydney rent is the highest in the country and Adelaide is among the lowest. Rank on tuition and you miss this entirely. The [cost of living by city](/cost-of-living) pages and the [cost calculator](/cost-calculator) let you put real rent figures against each option.\n\n## A longer degree is a whole extra year of everything\n\nCourse length varies more than people expect. A pass bachelor is three years; add honours or a professional accreditation and it can be four. A coursework masters can be one year, one and a half, or two, depending on whether you get credit for your prior study.\n\nEach extra year is another year of tuition and another year of living costs, so roughly AUD 55,000 to AUD 65,000. A university charging AUD 4,000 more a year but finishing you a year sooner is cheaper overall. When you compare offers, multiply the annual tuition by the actual number of years, and check whether your bachelor degree earns you credit toward the masters.\n\n## The list price is not the price you pay\n\nMany Australian universities apply an automatic scholarship to international students, often a 10 to 25 percent reduction, with no separate application. The published fee is the list price; the offer letter shows the discounted one. A university that looks mid-priced on a tuition table can land cheaper than a \"cheap\" university once its automatic reduction is applied. See [universities with automatic scholarships](/best/australian-universities-with-automatic-scholarships) and check each offer letter for the net figure.\n\n## If permanent residence is the goal, regional study has a cash value\n\nStudying in a designated [regional area](/guides/choosing-a-regional-area-to-study-in-australia), which includes Adelaide, Perth, Canberra, and everywhere outside Sydney, Melbourne, and Brisbane, does two things. Regional universities tend to charge less. And regional study adds five points to a later skilled visa and can add a year or two to the [485 graduate visa](/guides/temporary-graduate-visa-485-guide). If your plan runs through to permanent residence, a metropolitan degree carries a cost that never appears on a tuition table: the points and the extra work rights you gave up.\n\n## Worked example\n\nTwo offers for the same field, both three-year bachelor degrees:\n\n| | University A, Sydney | University B, Adelaide |\n| --- | --- | --- |\n| Tuition per year | AUD 33,000 | AUD 36,000 |\n| Living cost per year | AUD 33,000 | AUD 28,000 |\n| Automatic scholarship | none | 15 percent off tuition |\n| Net tuition per year | AUD 33,000 | AUD 30,600 |\n| Total over 3 years | AUD 198,000 | AUD 175,800 |\n| Regional migration points | 0 | 5 |\n\nUniversity A has the lower published tuition. University B is more than AUD 22,000 cheaper over the degree and puts you ahead on points. The tuition rank pointed the wrong way.\n\n## The cost of getting it wrong\n\nThree avoidable costs dwarf a tuition difference:\n\n- A **refused student visa**. The charge is AUD 2,500 and it is not refunded. A weak application that gets refused costs you the fee, the delay, and a mark on your immigration history. See [if your student visa is refused](/guides/what-to-do-if-your-student-visa-is-refused).\n- A **failed subject**. You pay again to repeat it, and it can push your finish date and your visa out.\n- **Transferring** after you start. Credit does not always carry across, so units you paid for at the first university can be worthless at the second. See [transferring universities without losing credits](/guides/transferring-universities-without-losing-credits).\n\n## Where to actually look\n\nStart with the tuition-ranked lists, then correct for the four factors above:\n\n- [Most affordable universities](/best/affordable-australian-universities-for-international-students), ranked by first-year budget rather than tuition alone\n- [Regional universities for skilled migration](/best/regional-australian-universities-for-skilled-migration)\n- [The real cost of studying in Australia](/guides/real-cost-of-studying-in-australia) for the full budget breakdown\n\n## What is the cheapest university in Australia for international students?\n\nThere is no single answer, because it depends on the city you live in, the length of the course, and the scholarship you are offered. Regional universities in Adelaide, Perth, and Canberra tend to be cheapest once living costs are included, and several newer public universities sit well below the Group of Eight on tuition. Rank a list by first-year budget, then adjust for course length and any automatic scholarship in your offer.\n\n## Is it cheaper to study in a regional area?\n\nUsually, on two counts. Regional universities generally charge less tuition, and regional cities have lower rent than Sydney or Melbourne. Regional study also adds five points toward a skilled visa and can extend the post-study graduate visa, which has a value if permanent residence is your goal.\n\n## Do Australian universities give automatic scholarships to international students?\n\nMany do. A common form is a fixed percentage reduction in international tuition, often 10 to 25 percent, applied automatically with no separate application and shown in the offer letter. It can change which university is actually cheapest for you, so compare offers on the net figure, not the published fee.\n\n## Does a shorter degree save money?\n\nYes, significantly. Each year of study is a year of tuition plus a year of living costs, roughly AUD 55,000 to AUD 65,000. A one-year masters, or a two-year masters where your bachelor earns you credit, can cost far less overall than a cheaper-per-year course that runs longer.",
    sources: [
      "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/student-500",
      "https://www.studyaustralia.gov.au/",
    ],
