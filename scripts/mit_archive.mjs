...
// Archive Melbourne Institute of Technology program rows with cited evidence, writing
// BOTH status='archived' and discontinued_note (icms/kbs_archive.mjs pattern; a past
// bug in archive_programs.mjs silently dropped discontinued_note from writes).
//
//   node scripts/mit_archive.mjs scripts/data/mit_archive_list.json          # dry run
//   node scripts/mit_archive.mjs scripts/data/mit_archive_list.json --commit
//
...
const logFile = path.join("scripts", "data", "mit-archived.json");
