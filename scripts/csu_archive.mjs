...
// Archive Melbourne Polytechnic program rows with cited evidence, writing BOTH status='archived'
...
//
//   node scripts/acu_archive.mjs scripts/data/acu_archive_list.json          # dry run
//   node scripts/acu_archive.mjs scripts/data/acu_archive_list.json --commit
//
...
const logFile = path.join("scripts", "data", "csu-archived.json");
