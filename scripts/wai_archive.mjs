...
//
//   node scripts/wai_archive.mjs scripts/data/tq_archive_list.json          # dry run
//   node scripts/wai_archive.mjs scripts/data/tq_archive_list.json --commit
//
...
const logFile = path.join("scripts", "data", "wai-archived.json");
