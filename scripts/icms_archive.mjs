...
// Archive TAFE Queensland program rows with cited evidence, writing BOTH status='archived'
...
//
//   node scripts/tafe_archive.mjs scripts/data/tq_archive_list.json          # dry run
//   node scripts/tafe_archive.mjs scripts/data/tq_archive_list.json --commit
//
...
const logFile = path.join("scripts", "data", "icms-archived.json");
