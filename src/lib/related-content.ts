...
const GUIDE_LABEL: Record<string, string> = {
  ...
  "australian-student-visa-from-india": "The student visa from India",
  "australian-student-visa-from-nepal": "The student visa from Nepal",
  "cheapest-australian-university-tuition-vs-total-cost":
    "Cheapest tuition vs cheapest degree",
  ...
  "skilled-occupation-lists-explained": "MLTSSL, STSOL, CSOL and ROL explained",
...
const GUIDE_RELATED: Record<string, RelatedLink[]> = {
  ...
  "which-australian-courses-lead-to-permanent-residence": [
    ...
    g("getting-a-skills-assessment-in-australia"),
    g("how-the-australian-points-test-works"),
    g("skilled-occupation-lists-explained"),
    v("temporary-graduate-485"),
    CALCULATOR,
  ],
  ...
  "skilled-occupation-lists-explained": [
    g("getting-a-skills-assessment-in-australia"),
    g("how-the-australian-points-test-works"),
    g("which-australian-courses-lead-to-permanent-residence"),
    v("skilled-independent-189"),
  ...
  "choosing-a-regional-area-to-study-in-australia": [
    g("how-the-australian-points-test-works"),
    g("study-to-permanent-residence-pathway-australia"),
    g("cheapest-australian-university-tuition-vs-total-cost"),
  ...
  "cheapest-australian-university-tuition-vs-total-cost": [
    g("real-cost-of-studying-in-australia"),
    g("choosing-a-regional-area-to-study-in-australia"),
    g("transferring-universities-without-losing-credits"),
    AFFORDABLE_UNIS,
    {
  ...
  "australian-student-visa-from-nepal": [
    g("cost-of-studying-in-australia-from-nepal"),
    g("proving-funds-for-an-australian-student-visa"),
    g("documents-checklist-for-an-australian-student-visa"),
    g("what-to-do-if-your-student-visa-is-refused"),
  ...
  "australian-student-visa-from-india": [
    g("cost-of-studying-in-australia-from-india"),
    g("proving-funds-for-an-australian-student-visa"),
    g("documents-checklist-for-an-australian-student-visa"),
    g("what-to-do-if-your-student-visa-is-refused"),
