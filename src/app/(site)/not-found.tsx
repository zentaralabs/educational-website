...
// Rendered for notFound() calls inside the (site) route group. The site
// header and footer come from (site)/layout.tsx, so this file must NOT
// render its own chrome. The root app/not-found.tsx (which does include
// chrome) handles URLs that never match this group.
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-16">
      ...
      <p className="mt-4 font-body text-base leading-relaxed text-slate">
        It may have moved, or the link may be wrong. If you followed a link from
        another page on this site, tell us at{" "}
        <a
      ...
      <p className="mt-8 font-body text-sm text-slate">
        Or{" "}
        <Link href="/" className="text-status-open underline underline-offset-2">
