...
- First two lines are a specific, non-obvious fact pulled from the guide. Never "check out our new guide" or "excited to share".
- One link to the new `/guides/<slug>` page. One line noting figures are sourced from official pages and carry a "last verified" date.
